...
namespace AmortizationPlansForLoansFinalProject.Services.Services.Implementations
    {
        public class LoanInputService : ILoanInputService
        {
            ...
            public LoanInputService(
                ...
                IProductRepository productRepository, IProductConditionRepository productConditionRepository)
            {
            ...
            {
                var productConditions = _productConditionRepository.GetAllProductConditionsAsync().Result; 
